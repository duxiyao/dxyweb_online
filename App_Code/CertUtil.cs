...
namespace upacp_sdk_net.com.unionpay.sdk
{
    ...
    public class CertUtil
    {
        ...
        {
            String fileName = SDKConfig.SignCertPath;
            X509Certificate2 pc = new X509Certificate2(fileName, SDKConfig.SignCertPwd, X509KeyStorageFlags.MachineKeySet);
        ...
        {
            //String fileName = System.Web.HttpContext.Current.Server.MapPath("~") + SDKConfig.SignCertPath;
            String fileName = SDKConfig.SignCertPath;
            X509Certificate2 pc = new X509Certificate2(fileName, SDKConfig.SignCertPwd, X509KeyStorageFlags.MachineKeySet);
