...
namespace upacp_sdk_net.com.unionpay.sdk{
    ...
    public class SDKConfig
    {
        ...
        {
            get { return System.Web.HttpContext.Current.Server.MapPath(SDKConfig.encryptCert); }
        ...
        {
            get { return System.Web.HttpContext.Current.Server.MapPath(SDKConfig.signCertPath); }
        ...
        {
            get { return System.Web.HttpContext.Current.Server.MapPath(SDKConfig.validateCertDir); }
